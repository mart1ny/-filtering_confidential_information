...
## Приложение: “обходные” тест-кейсы (минимум)
- `12 34 56 7890` (разделение цифр)
- `4111-1111-1111-1111` (разделители)
- `O` вместо `0`, `I` вместо `1`
- паспорт с пробелами/переносами
- “ключ” в виде `sk_live_...` / `AKIA...` / `Bearer ...`