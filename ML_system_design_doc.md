...
2) Конфиденциальные сущности можно описать как:
   - контекстные (ФИО, “ключи”, неформатные идентификаторы), форматные (карты/телефоны/email) — ловятся ML.
3) Политика допустимости зависит от канала и роли (например, “в LLM чат — строго”).
4) Нужен механизм “обратной связи” по ошибкам (ложные блокировки/пропуски) для улучшений.
